...
# installing packages tidyverse, janitor, skirm, lubridate e ggplot
...
# loading packages tidyverse, janitor, skirm, lubridate e ggplot2
library("tidyverse")
library("janitor")
library("skimr")
library("lubridate")
...
```{r translating day_of_week, echo=TRUE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r translating months, message=FALSE, warning=FALSE, include=FALSE, message=FALSE}
